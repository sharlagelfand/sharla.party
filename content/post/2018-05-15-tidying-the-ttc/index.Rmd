...
I enjoyed my [last data tidying post](/post/tidying-toronto-open-data/) so much and I've tweeted [a couple](https://twitter.com/sharlagelfand/status/970796082769866752) of [times](https://twitter.com/sharlagelfand/status/981266217901182976) about the immense satisfaction I get from tidying data sets -- so this is long overdue.
...
ttc <- read_excel(here::here("content", "post", "2018-05-15-tidying-the-ttc", "1985-2017 Analysis of ridership.xlsx"))
```
