...
basic_information_tidy <- readRDS(here("content", "post", "2019-03-14-february-2019-more-discogging", "basic_information_tidy.rds"))
...
```{r}
manual_locations <- readr::read_csv(here("content", "post", "2019-03-14-february-2019-more-discogging", "manual_locations.csv"))
