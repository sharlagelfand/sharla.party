...
In parts [one](/post/discog-purrr/) and [two](/post/more-discogs) of this series I did a whole lot of API pulling and data cleaning to get my [discogs](https://discogs.com/) collection into a tidy state `r emo::ji("pray")` Now I'm finally ready to do something with it!
...
collection_data <- readRDS(here("content", "post", "2019-03-15-february-2019-visualizing-my-discogs-collection", "collection_data.rds")) %>%
  as_tibble()
```
