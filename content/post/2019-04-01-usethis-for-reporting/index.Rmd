...
january_delays <- read_excel(here::here("content", "post", "2019-04-01-usethis-for-reporting", "Subway_&_SRT_Logs_January_2019.xlsx"))

january_delays
```

I have to clean the data a little (you might expect this from [my post using this data before](/post/new-data-strategies)).
...
```{r}
delay_codes <- read_excel(here::here("content", "post", "2019-04-01-usethis-for-reporting", "Subway & SRT Log Codes.xlsx")) %>%
  clean_names()
```
